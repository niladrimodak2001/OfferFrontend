...
const OfferLetterPage = () => {
  ...
  const handleDeleteField = async (i) => {
    try {
      const { data } = await axios.put(
        `${import.meta.env.VITE_BASE_API_URL}/field/${templateId}/delete/${i}`
      );
      fetchTemplateAddedFields(templateId);
      toast.success("Field delete successfully");
    } catch (error) {
      console.log(error);
      toast.error(error);
    }
              ...
              >
                <div className="flex-1 overflow-y-auto space-y-2">
                  {allAddedFields?.map((f, idx) => (
                    <div className="flex w-full  gap-2" f={f} idx={idx}>
                      <SortableItem
                        key={f._id}
                        id={f._id}
                      ...
                      <button
                        ...
                        className="text-red-500 w-fit  hover:text-red-700 cursor-pointer"
                    ...
                    {val?.subCategory === "Salary" ? (
                      ...
                      <>
                        ...
                        <div className="flex flex-col gap-1">
                          <div className="w-full flex justify-between">
                            <h3 className="text-md text-blue-500 font-semibold mb-2">
                              Placeholders
                            </h3>
                              ...
                              >
                                ...
                                <div className="text-gray-700 flex gap-2">
                                  ...
                                  <input
                                    ...
                                    className={`w-10/12 rounded-sm px-1 ${
